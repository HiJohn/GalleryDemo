...
class VideoGridAdapter : RecyclerView.Adapter<VideoGridAdapter.VideoHolder>() {
    ...
    class VideoHolder constructor(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        val thumb:ImageView = itemView.findViewById(R.id.grid_video_thumb)
        val name:TextView = itemView.findViewById(R.id.grid_video_name)
